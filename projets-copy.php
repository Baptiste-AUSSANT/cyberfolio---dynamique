...
<body>
    ...
    <div class="all-content" id="0">
        <?php foreach ($projets as $projet): ?>
            <br> <br>
            <h1><?php echo $projet['h1']; ?></h1>
        <div class="content">
            <img src="<?php echo $projet['img_1']; ?>">
            <div class="text-content">
                <h2><?php echo $projet['h2_1']; ?></h2>
                <br>
                <p><?php echo $projet['p_1']; ?></p>
            </div>
        </div>
        <br><br><br><br>
        <div class="content">
            <div class="text-content">
                <h2><?php echo $projet['h2_2']; ?></h2>
                <br>
                <p><?php echo $projet['p_2']; ?></p>
            </div>
            <img src="<?php echo $projet['img_2']; ?>">
        </div>
        <?php endforeach; ?>
    </div>
